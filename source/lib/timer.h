...
#include "config2.h"	// CONFIG2_TIMER_ALLOW_RDTSC
#include "sysdep/cpu.h"	// cpu_AtomicAdd
#if ARCH_X86_X64 && CONFIG2_TIMER_ALLOW_RDTSC
# include "sysdep/os_cpu.h"	// os_cpu_ClockFrequency
# include "sysdep/arch/x86_x64/x86_x64.h"	// x86_x64::rdtsc
#endif
